...
def save_wav(filename, naive_data, fs=FS):
    """
    Save a 1D numpy array as a WAV file.
    """
    sf.write(filename, naive_data, fs)

def main():
    # Paths
    signal_dir = os.path.join("naive_data", "naive_signal_band")
    nonsignal_dir = os.path.join("naive_data", "naive_non_signal_band")
